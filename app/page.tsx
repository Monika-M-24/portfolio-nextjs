...
export default function Home() {
  ...
  useEffect(() => {
    let index = isDeletingName ? typedName.length - 1 : typedName.length + 1;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-500 to-[#0b1d3d] font-sans">
  ...
  <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-4 flex justify-between items-center">
    ...
    {/* Hide menu on mobile (we’ll add hamburger later) */}
...
>
  ...
  {showModal && (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
      ...
      <section
  id="contact"
  className="px-4 sm:px-8 md:px-12 lg:px-20 py-20 text-white flex justify-center"
>
  <div className="max-w-3xl w-full text-center">
    <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-sky-300 mb-6">
      Contact Me
    </h2>

    <p className="text-base sm:text-lg text-sky-100 mb-10">
      Feel free to reach out to me for opportunities, collaborations, or any
      questions.
    </p>

    <div className="space-y-5 text-sky-100 text-base sm:text-lg">

      {/* Mobile */}
      <div className="bg-white/10 rounded-lg p-4 hover:bg-white/15 transition">
        📞 <span className="font-medium">Mobile:</span>{" "}
        <a href="tel:8667560058" className="hover:text-sky-300">
          8667560058
        </a>
      </div>
      ...
      <div className="bg-white/10 rounded-lg p-4 hover:bg-white/15 transition">
        ...
        <a
          ...
          className="hover:text-sky-300 break-all"
        >
      ...
      <div className="bg-white/10 rounded-lg p-4 hover:bg-white/15 transition">
        ...
        <a
          ...
          className="hover:text-sky-300 underline break-all"
        >
